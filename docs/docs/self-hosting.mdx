...
```bash
curl https://raw.githubusercontent.com/usefloww/floww-self-hosting/main/docker-compose/install.sh | bash
```
...
<Badge type="warning">Coming soon (if interest is high)</Badge>