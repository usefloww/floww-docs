...
- **[Provider Configuration](/docs/configuration)** - Set up integrations with GitLab, Slack, AI models, and more
- **[Providers](/reference/builtin)** - Explore all available triggers and integrations
- **[Architecture](/docs/architecture)** - Understand how Floww works under the hood
